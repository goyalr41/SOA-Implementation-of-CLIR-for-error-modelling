...
import java.util.Set;
	...
	public class stopwordhin {
		...
		public stopwordhin(File Doc) throws IOException {
			stop = new HashSet<String>();
			URL url = getClass().getResource("stopwordhin.txt");
		...
		/*public static void main(String[] args) throws IOException {
			...
			URL url = stopwordhin.class.getResource("test.txt");
			File f = new File(url.getPath());
			System.out.println(f.length());
			stopwordhin stw = new stopwordhin(f);
