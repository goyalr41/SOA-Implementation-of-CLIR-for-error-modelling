...
public class term_freqmatrix {
	...
	public static  HashMap<String,Double> final_reshin = new HashMap<String,Double>(); 
	...
	public void filematrix_write() throws IOException
	{  
		
		File file = new File("C:/Users/hp/workspace/CLIRserver1/src/irhindi/data/tfidf.txt");
	...
	public void filematrix_read(){
		...
		try {
			reader = new BufferedReader(new FileReader("C:/Users/hp/workspace/CLIRserver1/src/irhindi/data/tfidf.txt"));
	...
	HashMap<String,Double> cosine_sim(String q)
	{
		...
		final_reshin = (HashMap<String,Double>) desc_sortByValues(final_result);
		//System.out.println("printing final doc weight values");
		 for (Map.Entry<String, Double> abc: final_reshin.entrySet()) {
			    //String doc = temp.get(arg0);
