...
public class QueryServiceLocator extends org.apache.axis.client.Service implements CLIR.server.QueryService {
    ...
    private java.lang.String Query_address = "http://localhost:13080/CLIRserver1/services/Query";
    ...
    public CLIR.server.Query getQuery() throws javax.xml.rpc.ServiceException {
    ...
    public CLIR.server.Query getQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CLIR.server.QuerySoapBindingStub _stub = new CLIR.server.QuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (CLIR.server.Query.class.isAssignableFrom(serviceEndpointInterface)) {
                CLIR.server.QuerySoapBindingStub _stub = new CLIR.server.QuerySoapBindingStub(new java.net.URL(Query_address), this);
                _stub.setPortName(getQueryWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.CLIR", "QueryService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.CLIR", "Query"));
        }
