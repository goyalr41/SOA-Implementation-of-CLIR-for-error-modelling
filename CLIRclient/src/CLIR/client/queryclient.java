...
import CLIR.server.QueryServiceLocator;
...
public class queryclient {
	...
	public void query(String querytext, String Lang, String Trans) throws Exception {
		...
		QueryServiceLocator locator1 = new QueryServiceLocator();
		Query requestor1 = locator1.getQuery();
		
	byte[] file = requestor1.query(querytext.toLowerCase().trim(), Lang.toLowerCase().trim(), Trans.toLowerCase().trim());
	
	File fil = new File("C:/Users/hp/workspace/CLIRserverfi/src/Temp/"+"solution123.txt");
	...
	List<String> lines = Files.readAllLines(Paths.get("C:/Users/hp/workspace/CLIRserverfi/src/Temp/"+"solution123.txt"),
